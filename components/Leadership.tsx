    ...
    <section className="py-32 px-6 lg:px-12 max-w-6xl mx-auto">
      ...
      <div className="space-y-6">
        {leadership.map((item, index) => (
          <div key={index} className="flex flex-col lg:flex-row lg:items-baseline lg:gap-8 pb-6 border-b border-[#e5e5e5] last:border-b-0">
            <div className="flex-1">
              <h3 className="font-serif text-xl lg:text-2xl font-light text-[#171717] mb-2">
                {item.role}
              </h3>
            ...
            <p className="font-mono text-xs uppercase tracking-widest text-[#737373] mt-3 lg:mt-0">
              {item.period}
            </p>
          </div>
        ))}
